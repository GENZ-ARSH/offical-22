...
// Middleware
app.use(cors({ origin: ['http://localhost:5000', 'https://your-netlify-site.netlify.app'], credentials: true }));
...
async function generateShortUrl(duration) {
    ...
    try {
        const baseUrl = duration === '24hr' ? 'http://localhost:5000/home.html' : 'http://localhost:5000/home.html';
...
app.listen(PORT, () => {
    ...
    console.log(`LINK_PAYS_API_KEY: ${LINK_PAYS_API_KEY}`);
});
